...
//        filterChainMap.put("/login","formAuthc");//自定义过滤

        filterChainMap.put("/login.html",DefaultFilter.anon.name());
        filterChainMap.put("/dologin",DefaultFilter.anon.name());
        ...
        filterChainMap.put("/**", "formAuthc");//DefaultFilter.authc.name()
